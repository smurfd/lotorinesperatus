...
class Amd64_elf:
  ...
  def get_instructions(self, i) -> Literal:
    if   i[:23] == '0b100100111000001111111': return f'sarq $0x3, %r12'
    elif i[:23] == '0b100100110000011111111': return f'cmpq $0x1, %r12'
    elif i[:23] == '0b100100110000011110101': return f'adcq $0x0, %r12'
    elif i[:21] == '0b1001000110000011110': return 'shrq $0x3f, %rsi'
    elif i[:21] == '0b1001000110000011111': return 'sarq $0x3, %rax'
    elif i[:20] == '0b100100010000011111': return f'subq ${hex(int(i[29:34], 2))}, %rsp'
    elif i[:20] == '0b100100010000011110': return f'addq ${hex(int(i[29:34], 2))}, %rsp'
    ...
    elif i[:18] == '0b1001000100000111': return f'cmpq $0x2, %rax'
    elif i[:18] == '0b1111111111100000': return f'jmpq *%rax'
    elif i[:17] == '0b111010100010111': return f'jne 0x400xxx'
    elif i[:17] == '0b100100110000011': return f'addq $0x8, %r14'
    elif i[:16] == '0b10010001000000': return f'cmpq $0x401xxx, %rbx'
    elif i[:16] == '0b10000011111110': return f'cmpl $0x2f, %ecx'
    elif i[:16] == '0b10000011111111': return f'callq *0x10(%r13)'
    elif i[:16] == '0b10010001000001': return f'addq $0x10, %rbx'
    ...
    elif i[:15] == '0b1001000100011': return f'leaq {hex(int(i[29:34], 2))}{int(i[18:26], 2):x}(%rip), %rdi'  # TODO: wrong hex
    ...
    elif i[:14] == '0b100000110001': return 'movl %edi, %r15d'
    elif i[:14] == '0b100100110001': return 'movq %rsi, %r14'
    elif i[:14] == '0b100100010001': return f'movq %rsp, %rbp'
    elif i[:14] == '0b100110110001': return f'movq (%r13), %r12'
    elif i[:15] == '0b0010001000001': return f'cmpq $0x2, %rax'
    ...
    elif i[:14] == '0b111110110110': return f'movzbl -0x1(%rax), %ecx'
    elif i[:14] == '0b100000110000': return f'cmpl $0x25, 0x8(%r13)'
