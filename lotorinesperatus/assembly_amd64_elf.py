...
class Amd64_elf:
  ...
  def get_instructions(self, i) -> Literal:
    if i[5:14]:  # TODO: check same positions and length?
      if   i[2:14] == '100100000111': return f'cmpq %rdi, %rax'
      elif i[2:14] == '100100110000': return f'cmpq $0x401xxx, %r12'
      elif i[2:19] == '10010010010100111': return f'subq %rax, %r12'
      elif i[2:23] == '100100111000001111111': return f'sarq $0x3, %r12'
      elif i[2:23] == '100100110000011111111': return f'cmpq $0x1, %r12'
      elif i[2:23] == '100100110000011110101': return f'adcq $0x0, %r12'
      elif i[2:20] == '100010100110001111': return f'xorl %r13d, %r13d'
      elif i[2:20] == '100100111111111110': return f'incq %r13'
      elif i[2:20] == '100110100111001111': return f'cmpq %r13, %r12'
      elif i[2:17] == '100100110000011': return f'addq $0x8, %r14'
      elif i[2:16] == '10000011111110': return f'cmpl $0x2f, %ecx'
      elif i[2:16] == '10000011111111': return f'callq *0x10(%r13)'
      elif i[2:14] == '100100011111': return f'incq %rax'
      elif i[2:14] == '111001101001': return f'jae 0x400xxx'
      elif i[2:12] == '1100011100': return f'xorl %ecx, %ecx'
      elif i[2:12] == '1111110001': return f'jle  0x400xxx'
      elif i[2:16] == '10010101000101': return f'movq 0x401xxx(,%r13,8), %rax'
      elif i[2:18] == '1001000100000111': return f'cmpq $0x2, %rax'
      elif i[2:14] == '100010010001': return f'movl %r15d, %edi'
      elif i[2:14] == '100110010001': return f'movq %r14, %rsi'
      elif i[2:14] == '100100110000': return f'cmpq $0x401xxx, %r12'
      elif i[2:14] == '101110001100': return f'movl $0x401xxx, %eax'
      elif i[2:14] == '111110110110': return f'movzbl -0x1(%rax), %ecx'
      elif i[2:14] == '100000110000': return f'cmpl $0x25, 0x8(%r13)'
      elif i[2:12] == '1110010000': return f'jb 0x400xxx'
      elif i[2:14] == '111110100010': return f'cpuid'
      elif i[2:14] == '100100101100': return f'movslq %r15d, %rax'
      ...
      elif i[2:13] == '10001001110': return f'movl %eax, %edi'
      ...
      elif i[2:13] == '10010001111': return f'decq %rbx'
      ...
      elif i[2:9]  == '1010011': return f'pushq %rbx'
      elif i[2:9]  == '1010000': return f'pushq %rax'
      elif i[2:9]  == '1010101' and len(i) == len('0b1010101'): return f'pushq %rbp'
      ...
      elif i[2:9]  == '1011101' and len(i) == len('0b1011101'): return f'popq %rpb'
      elif i[2:9]  == '1011101': return f'movl $0x401xxx, %ebx'
      ...
      elif i[2:12] == '1111111111': return f'callq *%rax'
      elif i[2:11] == '111010000': return f'callq 0x400xxx'
      elif i[2:12] == '1110010111': return f'jb	0x400xxx'
      ...
      elif i[2:14] == '100000110001': return 'movl %edi, %r15d'
      elif i[2:14] == '100100110001': return 'movq %rsi, %r14'
      elif i[2:14] == '100100010001': return f'movq %rsp, %rbp'
      elif i[2:14] == '100110110001': return f'movq (%r13), %r12'
      elif i[2:17] == '10010001000000': return f'cmpq $0x401xxx, %rbx'
      elif i[2:15] == '0010001000001': return f'cmpq $0x2, %rax'
      elif i[2:14] == '100100010000': return f'testq %rax, %rax'
      elif i[2:14] == '100100010110': return f'sarq %rsi'
      elif i[2:9]  == '1011011': return f'popq %rbx'
      elif i[2:14] == '100100000101': return f'subq %rdi, %rsi'
      elif i[2:10] == '11001101': return f'nop'
      elif i[2:10] == '10010000': return f'nop'
      elif i[2:12] == '1100110001': return f'nopw (%rax,%rax)'
