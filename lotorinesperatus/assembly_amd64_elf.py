...
class Amd64_elf:
  ...
  def get_instructions(self, i) -> Literal:
    if i[5:14]:  # TODO: check same positions and length?
      ...
      elif i[2:14] == '100000111111': return f'cmpl $0x2f, %ecx'
      elif i[2:14] == '100000111111': return f'callq *0x10(%r13)'
      ...
      elif i[2:9]  == '1011101' and len(i) == len('0b1011101'): return f'popq %rbp'
